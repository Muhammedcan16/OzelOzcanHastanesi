    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Göz Hastalıkları</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/goz.jpg" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                        ...
                        Dünyayı, yaşamı, sevdiklerimizi sağlıklı görmek kadar güzel bir şey var mı? Hastanemiz, yetkin kadrosu ve modern teknolojiye sahip ekipmanlarıyla, göz sağlığınızın korunup geliştirilmesine en iyi şekilde destek sağlıyor. Hastanemizin, sağlıklı gözler ve mutlu bir yaşam için sizlere verdiği hizmetler şunlardır:
                      
                </p>
                <p class="display-9 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    
                        Bilgisayarlı göz ve gözlük muayenesi
                        <br>Genel göz muayenesi
                        <br>FAKO yöntemi-Katarakt cerrahisi ünitesi
                        <br>Çocuk göz hastalıkları ve şaşılık ünitesi
                        <br>Göz tansiyonu (glokom)ünitesi
                        <br>Kontakt lens ünitesi
                        <br>Retina hastalıkları ve diyabet ünitesi
                        <br>Vitrektomi ünitesi
                        <br>Keratokonüs ünitesi
                        <br>Kornea hastalıkları
                        <br>FFA (Göz anjiosu)
                        <br>OCT
                        <br>Korneal topografi
                        <br>Göz kapağı hastalıkları cerrahisi
                        <br>Gözyaşı kanal tıkanıklığı tedavisi (Diyot laser ile)
                        <br>Kriyoterapi
                        <br>Pakimetri
                        <br>Yag laser
                        <br>Argon laser, teşhis ve tedavileri                  
