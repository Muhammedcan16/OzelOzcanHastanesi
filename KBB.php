    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Kulak Burun Boğaz</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/KBB.png" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    
                    Özellikle kış aylarında en çok başvuru alan Kulak Burun Boğaz Bölümümüzde, deneyimli doktorlarımızın titiz çalışmaları ve teknikleriyle, hastalarımıza daha sağlıklı bir yaşam sağlıyoruz. Kliniğimizde, hijyen muayene ortamıyla kulak, burun ve boğaz hastalıklarında uzman çözümler sunuyoruz. Hastanemizin, Kulak Burun Boğaz Kliniği’nde verilen hizmetler şunlardır:

                      
                </p>
                <p class="display-9 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    İşitme kayıpları
                        <br>Kulak enfeksiyonları
                        <br>Denge bozuklukları ve baş dönmesi
                        <br>Çınlama
                        <br>Kronik sinüzit
                        <br>Burun alerjileri
                        <br>Koku alma bozuklukları
                        <br>Burun kanamaları
                        <br>Burun tıkanıklığı ve burnun dış görünümü ile ilgili problemler
                        <br>Nazal polipozis
                        <br>Gözyaşı bezi tıkanıklıkları
                        <br>Ses bozuklukları
                        <br>Yutma problemleri
                        <br>Gastroözefajiyal reflü
                        <br>Baş ve boyun bölgesi iyi ve kötü tümörleri
                        <br>Kulak hastalıkları
                        <br>Orta kulak enfeksiyonları
                        <br>Bademcik ve geniz eti hastalıkları
                        <br>Alerji ve sinüs hastalıkları
                        <br>Hava yolu problemleri, teşhis ve tedavisi
