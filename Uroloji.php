    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Üroloji</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/Uroloji.jpg" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    ...
                    Ürolojik hastalıkların değişik alt gruplarına ait tüm tetkik ve tedavi işlemleri için deneyimli bir kadroyu bünyesinde barındıran kliniğimiz, günümüz teknolojisinin tıbbi uygulamalara sunduğu tüm kapalı ameliyat girişimleri için gereken son teknoloji ürünü sistemlere de mevcuttur. Hastanemizin Üroloji Kliniği’nde verdiği hizmetler şunlardır:

                      
                </p>
                <p class="display-9 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    Böbrek taşları, idrar yolları taşları, mesane taşları
                        <br>İdrar ve idrar yolları sorunları
                        <br>İdrar kesesi hastalıkları
                        <br>Prostat hastalıkları
                        <br>Böbrek, idrar kesesi, testis, prostat tümörleri
                        <br>Cinsel fonksiyon bozuklukları
                        <br>Çocuklarda idrar yollarındaki ve genital organlardaki anomaliler
                        <br>Sünnet
                        <br>İdrar kaçırmaları
                        <br>Çocuklarda gece işemeleri, teşhis ve tedavisi
