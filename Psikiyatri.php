...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Psikoloji</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/psikiyatri.jpg" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    ...
                    Akıl hastalıklarının teşhisi, tedavisi ve önlenmesi ile uğraşan bilim ve hekimlik dalıdır. İnsanın davranış dinamiklerini biyopsikososyal olarak açıklamak üzerine çalışan ve normal ile normal dışı davranış örüntülerini sınıflandırarak tedavi etmeye çabalayan tıp bilimi ve ruh hekimliğidir.Hastanemizin Psikiyatri Kliniği’nde verdiği hizmetler şunlardır:
    ...
    <br>Distimi 
    <br>Dikkat eksikliği 
    <br>Trvma sonrası stres bozukluğu 
    <br>Uyku bozukluğu 
    <br>Yeme bozukluğu 
    <br>Yaygın anksiyete bozukluğu 
    <br>Obsesif kompulsif bozukluk
    <br>Şizofreni
