    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Nöroloji</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/noroloji.jpg" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    ...
                    Hastanemiz, çeşitli nörolojik hastalıkları tanı ve tedavilerini işbirliği içinde gerçekleştiren nörolog grubuyla güçlenmiştir. Böylece, nöroloji sinir sisteminin anatomik ve fizyolojik özellikleri ile çeşitli nedenlerle ortaya çıkan bozuklukları ve klinik sendromlarını, deneyimli ellerle inceleyebiliyoruz. Nöroloji Bölümümüzde hastalarımıza verdiğimiz tedavi ve muayene hizmetlerimiz şunlardır:
                      
                </p>
                <p class="display-9 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    
                     Boyun ve bel ağrıları
                        <br>Baş ağrıları (Migren)
                        <br>Periferik sinir ve kas hastalıkları
                        <br>Baş dönmeleri
                        <br>Beyin damar hastalıkları
                        <br>Epilepsi
                        <br>Multiple skleroz hastalıkları
                        <br>Hareket hastalıkları
                        <br>Bunama hastalığı (Alzheimer hastalığı), teşhis ve tedavi                             
