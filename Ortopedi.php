...
<head>
    <title>Ortopedi & Travmatoloji</title>
    <meta charset="utf-8">
    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Ortopedi & Travmatoloji</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/Ortopedi.jpg" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    ...
                    Ortopedi ve Travmatoloji Bölümümüz, kas-iskelet sistemindeki hastalıkları hastanemizde yer alan tüm bölümlerle dayanışma içerisinde, hastalarımıza en uygun medikal ve cerrahi tedaviyi uygular. Ortopedi ve Travmatoloji Bölümümüz, yüksek teknolojik tıbbi cihazlarımız ve ileri tıbbi yöntemlerimizle hastalarımıza şu tedavileri uygular:
                      
                </p>
                <p class="display-9 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    Kırık, çıkıklar
                        <br>Artroskopik diz, omuz, ayak bileği cerrahisi
                        <br>Spor yaralanmaları
                        <br>Kalça, diz, omuz eklemi protezleri
                        <br>Deformite, kısalık
                        <br>Omuz hastalıkları
                        <br>Ayak hastalıkları
                        <br>Kas iskelet sistemi tümörleri
                        <br>Doğumsal anomaliler, teşhis ve tedavileri                                          
