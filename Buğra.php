        ...
        <div class="container">
            <div class="row d-flex align-items-center py-5">
                <div class="col-lg-6 text-start">
                    <h1 class="h2 py-5 text-primary typo-space-line">OP. DR. BUĞRA ERGÜNAY
                    </h1>
                    <p class="light-300">
                    Kulak Burun Boğaz Bölümümüzün Değerli Hocalarından:<br>
                        OP. DR. Buğra ERGÜNAY, İstanbul Üniversitesi ve Cerrahpaşa Tıp Fakültesi'nden mezun olmuştur. Uzmanlık eğitimini Uludağ Üniversitesi KBB Anabilim Dalı'nda tamamlayan, Beşer, sırasıyla Kırşehir Mucur Sağlık Merkezi (1982-1984), Uludağ Üniversitesi KBB Anabilim Dalı (1985-1989) ve Bursa Devlet Hastanesi (1991-2017) görev yapmıştır. Evli olan Ergünay, İngilizce bilmektedir.
                </div>
                <div class="col-lg-6">
