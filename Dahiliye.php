    ...
    <section class="container py-5">
        ...
        <div class="row pt-5">
            <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line"> Dahiliye</h2>
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="./assets/img/Dahiliye.jpg" alt="Card image cap">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 m-auto text-left justify-content-center">
                <p class="display-7 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    ...
                    İç organlarımızı gözümüzle göremediğimizden dolayı, hastalandıklarında süreci anlamamız zorlaşır. Bu nedenle, vücudumuzda fark ettiğimiz bazı tepkimelerle hastalığımızı anlayabilir ve müdahale etmeye yönelebiliriz. Vücudunuzda ters giden bir şey olduğunu hissettiğiniz anda bize başvurun. Unutmayın, erken teşhis hayat kurtarır. Dahiliye bölümümüzde hastalarımıza verdiğimiz hizmetler şunlardır:

                      
                </p>
                <p class="display-9 py-2 ps-2   border-top-0 border-end-0 border-bottom-0 border-start">
                    Yüksek tansiyon
                        <br>Kalp hastalıkları
                        <br>Şeker hastalıkları
                        <br>Solunum yolu hastalıkları
                        <br>Mide-bağırsak hastalıkları (Gastroenteroloji, gastroskopi, kolonoskopi)
                        <br>Böbrek hastalıkları
                        <br>Romatizmal hastalıklar
                        <br>Karaciğer-safra kesesi hastalıkları
                        <br>Kan hastalıkları
                        <br>Troid hastalıkları (Guatr)
                        <br>Allerjik hastalıklar, teşhis ve tedavileri                                          
